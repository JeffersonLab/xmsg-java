...
class cMsgMulticastListeningThread extends Thread {
     ...
     * @param successResponse contains xMsgProxy host and port
    ...
    public cMsgMulticastListeningThread(cMsgNameServer nameServer, int port, int multicastPort,
                                        MulticastSocket socket, int debug) {
        server          = nameServer;
    ...
    public void run() {
        ...
        DatagramPacket sendPacket  = new DatagramPacket(server.successResponse, server.successResponse.length);
